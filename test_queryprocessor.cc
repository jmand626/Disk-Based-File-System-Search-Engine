...
TEST(Test_QueryProcessor, TestQueryProcessorSingleIndex) {
  ...
  idx_list.push_back("../projdocs/unit_test_indices/books.idx");
  ...
  ASSERT_EQ(string("../projdocs/test_tree/books/leavesofgrass.txt"), res[0].document_name);
  ASSERT_EQ(3, res[0].rank);
  ASSERT_EQ(string("../projdocs/test_tree/books/ulysses.txt"), res[1].document_name);
  ASSERT_EQ(2, res[1].rank);
  ASSERT_EQ(string("../projdocs/test_tree/books/warandpeace.txt"), res[2].document_name);
  ...
  ASSERT_EQ(string("../projdocs/test_tree/books/warandpeace.txt"),
            res[0].document_name);
  ASSERT_EQ(6, res[0].rank);
  ASSERT_EQ(string("../projdocs/test_tree/books/ulysses.txt"),
            res[1].document_name);
...
TEST(Test_QueryProcessor, TestQueryMultiIndex) {
  ...
  // Set up the list of index files.
  list<string> idx_list;
  idx_list.push_back("../projdocs/unit_test_indices/bash.idx");
  idx_list.push_back("../projdocs/unit_test_indices/books.idx");
  idx_list.push_back("../projdocs/unit_test_indices/enron.idx");
  ...
  ASSERT_EQ(2U, res.size());
  ASSERT_EQ(string("../projdocs/test_tree/books/artofwar.txt"),
            res[0].document_name);
  ASSERT_EQ(8, res[0].rank);
  ASSERT_EQ(string("../projdocs/test_tree/enron_email/613."),
            res[1].document_name);
  ASSERT_EQ(2, res[1].rank);
  ...
  res = qp.ProcessQuery(query);
  ASSERT_EQ(3U, res.size());
  ASSERT_EQ(string("../projdocs/test_tree/books/mobydick.txt"),
            res[0].document_name);
  ASSERT_EQ(1314, res[0].rank);
  ASSERT_EQ(string("../projdocs/test_tree/books/leavesofgrass.txt"),
            res[1].document_name);
